...
from rospit.test_runner import map_test_suite_report, \
                               map_test_case_report, \
                               map_evaluation
...
class TestMapper(unittest.TestCase):
    ...
    def test_maps_test_suite_report(self):
        ...
        out_report = map_test_suite_report(in_report)
    ...
    def test_maps_test_case_report(self):
        ...
        out_report = map_test_case_report(in_report)
    ...
    def test_maps_evaluation(self):
        ...
        out_evaluation = map_evaluation(in_evaluation)
